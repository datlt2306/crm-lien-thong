...
class WalletResource extends Resource {
    ...
    public static function shouldRegisterNavigation(): bool
    {
        ...
        // Chỉ Admin và Kế toán mới xem được menu ví tiền
        ...
        return $table
            ...
            ->actions([
                ...
                \Filament\Actions\Action::make('transactions')
                    ...
                    ->url(fn(Wallet $record): string => route('filament.admin.resources.wallet-transactions.index', ['tableFilters[wallet_id][value]' => $record->id])),
            ])
            ->bulkActions([
