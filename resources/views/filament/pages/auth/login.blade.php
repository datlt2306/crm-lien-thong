<x-filament-panels::page.simple>
    ...
    @if ($errors->any())
        <div class="mb-6 p-4 rounded-xl bg-red-50 border border-red-100 dark:bg-red-900/20 dark:border-red-900/30">
    ...
    <div class="relative mt-8">
        ...
        <div class="relative flex justify-center text-sm font-medium leading-6">
            <span class="bg-[#fcfaf7] dark:bg-[#151310] px-6 text-stone-500 dark:text-stone-400">Hoặc đăng nhập nhanh bằng</span>
        </div>
    </div>
    ...
    <div class="mt-6">
        <a href="{{ route('auth.google') }}" 
           ...
           class="group flex w-full items-center justify-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-white shadow-[0_4px_12px_rgba(66,133,244,0.3)] hover:bg-[#3367D6] hover:shadow-[0_6px_20px_rgba(66,133,244,0.4)] active:scale-[0.98] transition-all duration-200">
            ...
            <span class="tracking-tight text-base">Tiếp tục với Google</span>
        </a>
    </div>
