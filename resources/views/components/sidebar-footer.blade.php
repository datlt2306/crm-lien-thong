<div class="px-3 py-3 border-t border-gray-100 dark:border-white/5">
    <form action="{{ filament()->getLogoutUrl() }}" method="post">
        @csrf
        <button type="submit" class="flex w-full justify-center px-3 py-2 text-sm font-medium rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/5 transition-all duration-75 group" title="Đăng xuất">
